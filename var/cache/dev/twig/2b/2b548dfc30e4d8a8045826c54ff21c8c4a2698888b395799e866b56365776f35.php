...
class __TwigTemplate_7990212b5f4b055e3a28de1bd80d27a40a8b1bc009786e2c4f17664677acb551 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["client"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["client"], "adresse", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>
                    <a
                     role=\"button\" 
...
\t   \t\t\t\tclass=\"btn btn-primary edit-data\"
            ...
            echo "\">edit
                    ...
                    <a role=\"button\" 
\t   \t\t\t\t   class=\"btn btn-primary del-data\"
                       href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["client"], "id", [], "any", false, false, false, 36)]), "html", null, true);
            echo "\">delete</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  164 => 47,  159 => 44,  150 => 40,  141 => 36,  134 => 32,  126 => 27,  118 => 22,  114 => 21,  110 => 20,  107 => 19,  102 => 18,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
            ...
            <tr>
                ...
                <td>
                    <a
                     role=\"button\" 
\t   \t\t\t\t class=\"btn btn-primary edit-data\"
                     href=\"{{ path('client_show', {'id': client.id}) }}\">show
                     </a>
                    <a 
                    role=\"button\" 
\t   \t\t\t\tclass=\"btn btn-primary edit-data\"
                    ...
                    <a role=\"button\" 
\t   \t\t\t\t   class=\"btn btn-primary del-data\"
                       href=\"{{ path('client_delete', {'id': client.id}) }}\">delete</a>
                </td>
            </tr>
        {% else %}
            <tr>
